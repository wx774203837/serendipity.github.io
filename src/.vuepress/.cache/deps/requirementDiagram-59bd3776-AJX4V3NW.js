...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.0.2/node_modules/mermaid/dist/requirementDiagram-59bd3776.js
var he = function() {
  var e = function(q, r2, s2, l2) {
    for (s2 = s2 || {}, l2 = q.length; l2--; s2[q[l2]] = r2)
      ;
    return s2;
  }, t = [1, 3], a2 = [1, 5], c = [1, 6], d = [1, 7], u = [1, 8], p = [5, 6, 8, 14, 16, 18, 19, 40, 41, 42, 43, 44, 45, 53, 71, 72], h = [1, 22], o = [2, 13], g = [1, 26], R = [1, 27], x = [1, 28], S = [1, 29], T = [1, 30], v = [1, 31], A2 = [1, 24], N = [1, 32], w = [1, 33], pe = [1, 36], F = [71, 72], fe = [5, 8, 14, 16, 18, 19, 40, 41, 42, 43, 44, 45, 53, 60, 62, 71, 72], _e = [1, 56], ye = [1, 57], ge = [1, 58], Ee = [1, 59], Re = [1, 60], me = [1, 61], Ie = [1, 62], O = [62, 63], M = [1, 74], P = [1, 70], Y = [1, 71], U = [1, 72], B = [1, 73], Q = [1, 75], j = [1, 79], X = [1, 80], J = [1, 77], Z = [1, 78], m = [5, 8, 14, 16, 18, 19, 40, 41, 42, 43, 44, 45, 53, 71, 72], re = {
    trace: function() {
    },
    yy: {},
    ...
    performAction: function(r2, s2, l2, i2, _, n, K) {
      var f = n.length - 1;
      switch (_) {
        case 6:
          this.$ = n[f].trim(), i2.setAccTitle(this.$);
          break;
        case 7:
        case 8:
          this.$ = n[f].trim(), i2.setAccDescription(this.$);
          break;
        case 9:
          i2.parseDirective("%%{", "open_directive");
          break;
        case 10:
          i2.parseDirective(n[f], "type_directive");
          break;
        case 11:
          n[f] = n[f].trim().replace(/'/g, '"'), i2.parseDirective(n[f], "arg_directive");
          break;
        case 12:
          i2.parseDirective("}%%", "close_directive", "pie");
          break;
        case 13:
          this.$ = [];
          break;
        case 19:
          i2.addRequirement(n[f - 3], n[f - 4]);
          break;
        case 20:
          i2.setNewReqId(n[f - 2]);
          break;
        case 21:
          i2.setNewReqText(n[f - 2]);
          break;
        case 22:
          i2.setNewReqRisk(n[f - 2]);
          break;
        case 23:
          i2.setNewReqVerifyMethod(n[f - 2]);
          break;
        case 26:
          this.$ = i2.RequirementType.REQUIREMENT;
          break;
        case 27:
          this.$ = i2.RequirementType.FUNCTIONAL_REQUIREMENT;
          break;
        case 28:
          this.$ = i2.RequirementType.INTERFACE_REQUIREMENT;
          break;
        case 29:
          this.$ = i2.RequirementType.PERFORMANCE_REQUIREMENT;
          break;
        case 30:
          this.$ = i2.RequirementType.PHYSICAL_REQUIREMENT;
          break;
        case 31:
          this.$ = i2.RequirementType.DESIGN_CONSTRAINT;
          break;
        case 32:
          this.$ = i2.RiskLevel.LOW_RISK;
          break;
        case 33:
          this.$ = i2.RiskLevel.MED_RISK;
          break;
        case 34:
          this.$ = i2.RiskLevel.HIGH_RISK;
          break;
        case 35:
          this.$ = i2.VerifyType.VERIFY_ANALYSIS;
          break;
        case 36:
          this.$ = i2.VerifyType.VERIFY_DEMONSTRATION;
          break;
        case 37:
          this.$ = i2.VerifyType.VERIFY_INSPECTION;
          break;
        case 38:
          this.$ = i2.VerifyType.VERIFY_TEST;
          break;
        case 39:
          i2.addElement(n[f - 3]);
          break;
        case 40:
          i2.setNewElementType(n[f - 2]);
          break;
        case 41:
          i2.setNewElementDocRef(n[f - 2]);
          break;
        case 44:
          i2.addRelationship(n[f - 2], n[f], n[f - 4]);
          break;
        case 45:
          i2.addRelationship(n[f - 2], n[f - 4], n[f]);
          break;
        case 46:
          this.$ = i2.Relationships.CONTAINS;
          break;
        case 47:
          this.$ = i2.Relationships.COPIES;
          break;
        case 48:
          this.$ = i2.Relationships.DERIVES;
          break;
        case 49:
          this.$ = i2.Relationships.SATISFIES;
          break;
        case 50:
          this.$ = i2.Relationships.VERIFIES;
          break;
        case 51:
          this.$ = i2.Relationships.REFINES;
          break;
        case 52:
          this.$ = i2.Relationships.TRACES;
          break;
      }
    },
    table: [{ 3: 1, 4: 2, 6: t, 9: 4, 14: a2, 16: c, 18: d, 19: u }, { 1: [3] }, { 3: 10, 4: 2, 5: [1, 9], 6: t, 9: 4, 14: a2, 16: c, 18: d, 19: u }, { 5: [1, 11] }, { 10: 12, 20: [1, 13] }, { 15: [1, 14] }, { 17: [1, 15] }, e(p, [2, 8]), { 20: [2, 9] }, { 3: 16, 4: 2, 6: t, 9: 4, 14: a2, 16: c, 18: d, 19: u }, { 1: [2, 2] }, { 4: 21, 5: h, 7: 17, 8: o, 9: 4, 14: a2, 16: c, 18: d, 19: u, 23: 18, 24: 19, 25: 20, 26: 23, 32: 25, 40: g, 41: R, 42: x, 43: S, 44: T, 45: v, 53: A2, 71: N, 72: w }, { 11: 34, 12: [1, 35], 22: pe }, e([12, 22], [2, 10]), e(p, [2, 6]), e(p, [2, 7]), { 1: [2, 1] }, { 8: [1, 37] }, { 4: 21, 5: h, 7: 38, 8: o, 9: 4, 14: a2, 16: c, 18: d, 19: u, 23: 18, 24: 19, 25: 20, 26: 23, 32: 25, 40: g, 41: R, 42: x, 43: S, 44: T, 45: v, 53: A2, 71: N, 72: w }, { 4: 21, 5: h, 7: 39, 8: o, 9: 4, 14: a2, 16: c, 18: d, 19: u, 23: 18, 24: 19, 25: 20, 26: 23, 32: 25, 40: g, 41: R, 42: x, 43: S, 44: T, 45: v, 53: A2, 71: N, 72: w }, { 4: 21, 5: h, 7: 40, 8: o, 9: 4, 14: a2, 16: c, 18: d, 19: u, 23: 18, 24: 19, 25: 20, 26: 23, 32: 25, 40: g, 41: R, 42: x, 43: S, 44: T, 45: v, 53: A2, 71: N, 72: w }, { 4: 21, 5: h, 7: 41, 8: o, 9: 4, 14: a2, 16: c, 18: d, 19: u, 23: 18, 24: 19, 25: 20, 26: 23, 32: 25, 40: g, 41: R, 42: x, 43: S, 44: T, 45: v, 53: A2, 71: N, 72: w }, { 4: 21, 5: h, 7: 42, 8: o, 9: 4, 14: a2, 16: c, 18: d, 19: u, 23: 18, 24: 19, 25: 20, 26: 23, 32: 25, 40: g, 41: R, 42: x, 43: S, 44: T, 45: v, 53: A2, 71: N, 72: w }, { 27: 43, 71: [1, 44], 72: [1, 45] }, { 54: 46, 71: [1, 47], 72: [1, 48] }, { 60: [1, 49], 62: [1, 50] }, e(F, [2, 26]), e(F, [2, 27]), e(F, [2, 28]), e(F, [2, 29]), e(F, [2, 30]), e(F, [2, 31]), e(fe, [2, 55]), e(fe, [2, 56]), e(p, [2, 4]), { 13: 51, 21: [1, 52] }, e(p, [2, 12]), { 1: [2, 3] }, { 8: [2, 14] }, { 8: [2, 15] }, { 8: [2, 16] }, { 8: [2, 17] }, { 8: [2, 18] }, { 28: [1, 53] }, { 28: [2, 53] }, { 28: [2, 54] }, { 28: [1, 54] }, { 28: [2, 59] }, { 28: [2, 60] }, { 61: 55, 64: _e, 65: ye, 66: ge, 67: Ee, 68: Re, 69: me, 70: Ie }, { 61: 63, 64: _e, 65: ye, 66: ge, 67: Ee, 68: Re, 69: me, 70: Ie }, { 11: 64, 22: pe }, { 22: [2, 11] }, { 5: [1, 65] }, { 5: [1, 66] }, { 62: [1, 67] }, e(O, [2, 46]), e(O, [2, 47]), e(O, [2, 48]), e(O, [2, 49]), e(O, [2, 50]), e(O, [2, 51]), e(O, [2, 52]), { 63: [1, 68] }, e(p, [2, 5]), { 5: M, 29: 69, 30: P, 33: Y, 35: U, 37: B, 39: Q }, { 5: j, 39: X, 55: 76, 56: J, 58: Z }, { 32: 81, 71: N, 72: w }, { 32: 82, 71: N, 72: w }, e(m, [2, 19]), { 31: [1, 83] }, { 31: [1, 84] }, { 31: [1, 85] }, { 31: [1, 86] }, { 5: M, 29: 87, 30: P, 33: Y, 35: U, 37: B, 39: Q }, e(m, [2, 25]), e(m, [2, 39]), { 31: [1, 88] }, { 31: [1, 89] }, { 5: j, 39: X, 55: 90, 56: J, 58: Z }, e(m, [2, 43]), e(m, [2, 44]), e(m, [2, 45]), { 32: 91, 71: N, 72: w }, { 34: 92, 71: [1, 93], 72: [1, 94] }, { 36: 95, 46: [1, 96], 47: [1, 97], 48: [1, 98] }, { 38: 99, 49: [1, 100], 50: [1, 101], 51: [1, 102], 52: [1, 103] }, e(m, [2, 24]), { 57: 104, 71: [1, 105], 72: [1, 106] }, { 59: 107, 71: [1, 108], 72: [1, 109] }, e(m, [2, 42]), { 5: [1, 110] }, { 5: [1, 111] }, { 5: [2, 57] }, { 5: [2, 58] }, { 5: [1, 112] }, { 5: [2, 32] }, { 5: [2, 33] }, { 5: [2, 34] }, { 5: [1, 113] }, { 5: [2, 35] }, { 5: [2, 36] }, { 5: [2, 37] }, { 5: [2, 38] }, { 5: [1, 114] }, { 5: [2, 61] }, { 5: [2, 62] }, { 5: [1, 115] }, { 5: [2, 63] }, { 5: [2, 64] }, { 5: M, 29: 116, 30: P, 33: Y, 35: U, 37: B, 39: Q }, { 5: M, 29: 117, 30: P, 33: Y, 35: U, 37: B, 39: Q }, { 5: M, 29: 118, 30: P, 33: Y, 35: U, 37: B, 39: Q }, { 5: M, 29: 119, 30: P, 33: Y, 35: U, 37: B, 39: Q }, { 5: j, 39: X, 55: 120, 56: J, 58: Z }, { 5: j, 39: X, 55: 121, 56: J, 58: Z }, e(m, [2, 20]), e(m, [2, 21]), e(m, [2, 22]), e(m, [2, 23]), e(m, [2, 40]), e(m, [2, 41])],
    ...
    parse: function(r2) {
      var s2 = this, l2 = [0], i2 = [], _ = [null], n = [], K = this.table, f = "", ee = 0, be = 0, Le = 2, ke = 1, Oe = n.slice.call(arguments, 1), E = Object.create(this.lexer), C = { yy: {} };
      for (var se in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, se) && (C.yy[se] = this.yy[se]);
      E.setInput(r2, C.yy), C.yy.lexer = E, C.yy.parser = this, typeof E.yylloc > "u" && (E.yylloc = {});
      var ae = E.yylloc;
      n.push(ae);
      ...
      function De() {
        var $2;
        return $2 = i2.pop() || E.lex() || ke, typeof $2 != "number" && ($2 instanceof Array && (i2 = $2, $2 = i2.pop()), $2 = s2.symbols_[$2] || $2), $2;
      }
      for (var I, D, k, le, H = {}, te, V, Se, ie; ; ) {
        if (D = l2[l2.length - 1], this.defaultActions[D] ? k = this.defaultActions[D] : ((I === null || typeof I > "u") && (I = De()), k = K[D] && K[D][I]), typeof k > "u" || !k.length || !k[0]) {
          var ce = "";
          ie = [];
          for (te in K[D])
...
Expecting ` + ie.join(", ") + ", got '" + (this.terminals_[I] || I) + "'" : ce = "Parse error on line " + (ee + 1) + ": Unexpected " + (I == ke ? "end of input" : "'" + (this.terminals_[I] || I) + "'"), this.parseError(ce, {
        ...
        switch (k[0]) {
          case 1:
            l2.push(I), _.push(E.yytext), n.push(E.yylloc), l2.push(k[1]), I = null, be = E.yyleng, f = E.yytext, ee = E.yylineno, ae = E.yylloc;
            break;
          case 2:
            if (V = this.productions_[k[1]][1], H.$ = _[_.length - V], H._$ = {
              ...
              return le;
            V && (l2 = l2.slice(0, -1 * V * 2), _ = _.slice(0, -1 * V), n = n.slice(0, -1 * V)), l2.push(this.productions_[k[1]][0]), _.push(H.$), n.push(H._$), Se = K[l2[l2.length - 2]][l2[l2.length - 1]], l2.push(Se);
            break;
          case 3:
            return true;
        }
    ...
    var q = {
      EOF: 1,
      parseError: function(s2, l2) {
        if (this.yy.parser)
          this.yy.parser.parseError(s2, l2);
        else
          throw new Error(s2);
      },
      // resets the lexer, sets new input
      setInput: function(r2, s2) {
        return this.yy = s2 || this.yy || {}, this._input = r2, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = {
          first_line: 1,
          first_column: 0,
          last_line: 1,
          last_column: 0
      ...
      input: function() {
        ...
        var s2 = r2.match(/(?:\r\n?|\n).*/g);
        return s2 ? (this.yylineno++, this.yylloc.last_line++) : this.yylloc.last_column++, this.options.ranges && this.yylloc.range[1]++, this._input = this._input.slice(1), r2;
      },
      // unshifts one char (or a string) into the input
      unput: function(r2) {
        var s2 = r2.length, l2 = r2.split(/(?:\r\n?|\n)/g);
        this._input = r2 + this._input, this.yytext = this.yytext.substr(0, this.yytext.length - s2), this.offset -= s2;
        ...
        return this.yylloc = {
          ...
          last_column: l2 ? (l2.length === i2.length ? this.yylloc.first_column : 0) + i2[i2.length - l2.length].length - l2[0].length : this.yylloc.first_column - s2
        }, this.options.ranges && (this.yylloc.range = [_[0], _[0] + this.yyleng - s2]), this.yyleng = this.yytext.length, this;
      },
...
` + this.showPosition(), {
      ...
      showPosition: function() {
        var r2 = this.pastInput(), s2 = new Array(r2.length + 1).join("-");
        return r2 + this.upcomingInput() + `
` + s2 + "^";
      },
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: function(r2, s2) {
        var l2, i2, _;
      ...
      next: function() {
        ...
        for (var _ = this._currentRules(), n = 0; n < _.length; n++)
          if (l2 = this._input.match(this.rules[_[n]]), l2 && (!s2 || l2[0].length > s2[0].length)) {
            if (s2 = l2, i2 = n, this.options.backtrack_lexer) {
              if (r2 = this.test_match(l2, _[n]), r2 !== false)
                return r2;
              if (this._backtrack) {
                s2 = false;
                continue;
        ...
        return s2 ? (r2 = this.test_match(s2, _[i2]), r2 !== false ? r2 : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: function(s2, l2, i2, _) {
        switch (i2) {
          case 0:
          ...
          case 54:
            return "qString";
          case 55:
            return l2.yytext = l2.yytext.trim(), 71;
        }
      },
...
var Ze = function(e, t, a2) {
  ws.parseDirective(this, e, t, a2);
};
...
var at = (e) => (z2[e] === void 0 && (z2[e] = {
  name: e,
  type: L.type,
  docRef: L.docRef
}, et.info("Added new requirement: ", e)), L = {}, z2[e]);
var lt = () => z2;
var ct = (e) => {
  L !== void 0 && (L.type = e);
};
...
var yt = (e, t) => {
  let a2 = e.append("defs").append("marker").attr("id", ue.CONTAINS + "_line_ending").attr("refX", 0).attr("refY", t.line_height / 2).attr("markerWidth", t.line_height).attr("markerHeight", t.line_height).attr("orient", "auto").append("g");
  a2.append("circle").attr("cx", t.line_height / 2).attr("cy", t.line_height / 2).attr("r", t.line_height / 2).attr("fill", "none"), a2.append("line").attr("x1", 0).attr("x2", t.line_height).attr("y1", t.line_height / 2).attr("y2", t.line_height / 2).attr("stroke-width", 1), a2.append("line").attr("y1", 0).attr("y2", t.line_height).attr("x1", t.line_height / 2).attr("x2", t.line_height / 2).attr("stroke-width", 1), e.append("defs").append("marker").attr("id", ue.ARROW + "_line_ending").attr("refX", t.line_height).attr("refY", 0.5 * t.line_height).attr("markerWidth", t.line_height).attr("markerHeight", t.line_height).attr("orient", "auto").append("path").attr(
    "d",
    `M0,0
...
var Et = function(e, t, a2, c, d) {
  const u = a2.edge(W(t.src), W(t.dst)), p = z().x(function(o) {
    return o.x;
  }).y(function(o) {
    return o.y;
  ...
  t.type == d.db.Relationships.CONTAINS ? h.attr(
    "marker-start",
    "url(" + ah.getUrl(y.arrowMarkerAbsolute) + "#" + t.type + "_line_ending)"
  ) : (h.attr("stroke-dasharray", "10,7"), h.attr(
    "marker-end",
    "url(" + ah.getUrl(y.arrowMarkerAbsolute) + "#" + Ae.ReqMarkers.ARROW + "_line_ending)"
  )), gt(e, h, y, `<<${t.type}>>`);
};
var Rt = (e, t, a2) => {
  Object.keys(e).forEach((c) => {
    ...
    const u = a2.append("g").attr("id", c), p = "req-" + c, h = we(u, p);
    let o = Ve(u, c + "_title", [
      `<<${d.type}>>`,
      `${d.name}`
    ]);
...
var mt = (e, t, a2) => {
  Object.keys(e).forEach((c) => {
    let d = e[c];
    const u = W(c), p = a2.append("g").attr("id", u), h = "element-" + u, o = we(p, h);
...
var It = (e, t) => (e.forEach(function(a2) {
  let c = W(a2.src), d = W(a2.dst);
  t.setEdge(c, d, { relationship: a2 });
}), e);
var bt = function(e, t) {
  t.nodes().forEach(function(a2) {
    a2 !== void 0 && t.node(a2) !== void 0 && (e.select("#" + a2), e.select("#" + a2).attr(
      "transform",
      "translate(" + (t.node(a2).x - t.node(a2).width / 2) + "," + (t.node(a2).y - t.node(a2).height / 2) + " )"
    ));
  });
};
var W = (e) => e.replace(/\s/g, "").replace(/\./g, "_");
var kt = (e, t, a2, c) => {
  y = th().requirement, c.db.clear(), c.parser.parse(e);
  const d = y.securityLevel;
  let u;
  d === "sandbox" && (u = nh("#i" + t));
  const h = (d === "sandbox" ? nh(u.nodes()[0].contentDocument.body) : nh("body")).select(`[id='${t}']`);
  ...
  Rt(g, o, h), mt(R, o, h), It(x, o), ks(o), bt(h, o), x.forEach(function(N) {
    Et(h, N, o, t, c);
  });
  const S = y.rect_padding, T = h.node().getBBox(), v = T.width + S * 2, A2 = T.height + S * 2;
  $(h, A2, v, y.useMaxWidth), h.attr("viewBox", `${T.x - S} ${T.y - S} ${v} ${A2}`);
};
var St = {
  draw: kt
};
...
//# sourceMappingURL=requirementDiagram-59bd3776-AJX4V3NW.js.map
