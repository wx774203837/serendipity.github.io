...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.0.2/node_modules/mermaid/dist/svgDraw-c034b55e.js
var M = 0;
var O = function(i, e, t, r, n) {
  ...
  const l = e.points, d = z().x(function(o) {
    return o.x;
  }).y(function(o) {
    return o.y;
  }).curve(Ue), s = i.append("path").attr("d", d(l)).attr("id", "edge" + M).attr("class", "relation");
  let g = "";
  ...
  let B = fs.calcLabelPosition(e.points);
  f = B.x, c = B.y;
  let x, v, N, m;
  if (p % 2 !== 0 && p > 1) {
    let o = fs.calcCardinalityPosition(
      t.relation.type1 !== "none",
      e.points,
      e.points[0]
    ), u = fs.calcCardinalityPosition(
...
var L = function(i) {
  let e = "", t = "";
  try {
    let r = i[1] ? i[1].trim() : "", n = i[2] ? i[2].trim() : "", a = i[3] ? xl(i[3].trim()) : "", l = i[4] ? i[4].trim() : "", d = i[5] ? i[5].trim() : "";
    t = r + n + a + " " + l, e = S(d);
  } catch {
    t = i;
  }
...
var R = function(i) {
  let e = "", t = "";
  try {
    let r = i[1] ? i[1].trim() : "", n = i[2] ? i[2].trim() : "", a = i[3] ? xl(i[3].trim()) : "", l = i[4] ? i[4].trim() : "", d = i[5] ? " : " + xl(i[5]).trim() : "";
    t = r + n + "(" + a + ")" + d, e = S(l);
  } catch {
    t = i;
  }
...
var $ = function(i) {
  ...
  if (n > 1 && a > n && a <= i.length) {
    ...
    i.substring(a + 1, 1), t = S(i.substring(a + 1, a + 2)), e = l + d + "(" + xl(g.trim()) + ")", a < i.length && (r = i.substring(a + 2).trim(), r !== "" && (r = " : " + xl(r), e += r));
  } else
    e = xl(i);
  return {
    displayText: e,
...
//# sourceMappingURL=chunk-LXOXGOW4.js.map
