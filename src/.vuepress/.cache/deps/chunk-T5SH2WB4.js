...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.0.2/node_modules/mermaid/dist/edges-0979260b.js
var et2 = (a, t, r, n) => {
  t.forEach((e) => {
    pt[e](a, r, n);
  });
...
function gt(a) {
  const t = nh(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")), r = t.append("xhtml:div"), n = a.label, e = a.isNode ? "nodeLabel" : "edgeLabel";
  return r.html(
...
var bt = (a, t, r, n) => {
  let e = a || "";
  if (typeof e == "object" && (e = e[0]), _l(th().flowchart.htmlLabels)) {
    e = e.replace(/\\n|\n/g, "<br />"), et.info("vertexText" + e);
    const s = {
      isNode: n,
      label: ss(e).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
function wt(a, t, r, n) {
  var e, s, i, l, c, o, h, d, x, f, p, g, y, m, T2;
  if (e = t.y - a.y, i = a.x - t.x, c = t.x * a.y - a.x * t.y, x = e * r.x + i * r.y + c, f = e * n.x + i * n.y + c, !(x !== 0 && f !== 0 && Q(x, f)) && (s = n.y - r.y, l = r.x - n.x, o = n.x * r.y - r.x * n.y, h = s * a.x + l * a.y + o, d = s * t.x + l * t.y + o, !(h !== 0 && d !== 0 && Q(h, d)) && (p = e * l - s * i, p !== 0)))
    return g = Math.abs(p / 2), y = i * o - l * c, m = y < 0 ? (y - g) / p : (y + g) / p, y = s * c - e * o, T2 = y < 0 ? (y - g) / p : (y + g) / p, { x: m, y: T2 };
}
function Q(a, t) {
  return a * t > 0;
}
function mt(a, t, r) {
  ...
  return s.length ? (s.length > 1 && s.sort(function(p, g) {
    var y = p.x - r.x, m = p.y - r.y, T2 = Math.sqrt(y * y + m * m), $ = g.x - r.x, M = g.y - r.y, W = Math.sqrt($ * $ + M * M);
    return T2 < W ? -1 : T2 === W ? 0 : 1;
  }), s[0]) : a;
}
var kt = (a, t) => {
...
var Lt = (a, t) => {
  const { shapeSvg: r, bbox: n, halfPadding: e } = S(a, t, "node " + t.classes, true);
...
var St = Lt;
var V = (a, t) => {
  const { shapeSvg: r, bbox: n } = S(a, t, void 0, true), e = n.width + t.padding, s = n.height + t.padding, i = e + s, l = [
    { x: i / 2, y: 0 },
    { x: i, y: -i / 2 },
    { x: i / 2, y: -i },
    { x: 0, y: -i / 2 }
  ...
  return c.attr("style", t.style), w(t, c), t.intersect = function(o) {
    return et.warn("Intersect called"), u.polygon(t, l, o);
  }, r;
};
var Et = (a, t) => {
...
var Mt = (a, t) => {
  const { shapeSvg: r, bbox: n } = S(a, t, void 0, true), e = 4, s = n.height + t.padding, i = s / e, l = n.width + 2 * i + t.padding, c = [
    { x: i, y: 0 },
    { x: l - i, y: 0 },
    { x: l, y: -s / 2 },
    { x: l - i, y: -s },
...
var Bt = (a, t) => {
  const { shapeSvg: r, bbox: n } = S(a, t, void 0, true), e = n.width + t.padding, s = n.height + t.padding, i = [
    { x: -s / 2, y: 0 },
    { x: e, y: 0 },
    { x: e, y: -s },
    { x: -s / 2, y: -s },
...
var Nt = (a, t) => {
  const { shapeSvg: r, bbox: n } = S(a, t, void 0, true), e = n.width + t.padding, s = e / 2, i = s / (2.5 + e / 50), l = n.height + i + t.padding, c = "M 0," + i + " a " + s + "," + i + " 0,0,0 " + e + " 0 a " + s + "," + i + " 0,0,0 " + -e + " 0 l 0," + l + " a " + s + "," + i + " 0,0,0 " + e + " 0 l 0," + -l, o = r.attr("label-offset-y", i).insert("path", ":first-child").attr("style", t.style).attr("d", c).attr("transform", "translate(" + -e / 2 + "," + -(l / 2 + i) + ")");
...
var Ht = (a, t) => {
  const { shapeSvg: r } = S(a, t, "label", true);
  et.trace("Classes = ", t.classes);
...
function P(a, t, r, n) {
  ...
  t.includes("t") ? (et.debug("add top border"), s(r)) : i(r), t.includes("r") ? (et.debug("add right border"), s(n)) : i(n), t.includes("b") ? (et.debug("add bottom border"), s(r)) : i(r), t.includes("l") ? (et.debug("add left border"), s(n)) : i(n), a.attr("stroke-dasharray", e.join(" "));
}
var Xt = (a, t) => {
  let r;
  ...
  const f = i.node().appendChild(
    R(d.join ? d.join("<br/>") : d, t.labelStyle, true, true)
  );
  if (_l(th().flowchart.htmlLabels)) {
    const g = f.children[0], y = nh(f);
    h = g.getBoundingClientRect(), y.attr("width", h.width), y.attr("height", h.height);
  }
  const p = t.padding / 2;
  return nh(f).attr(
...
var Wt = (a, t) => {
  const { shapeSvg: r, bbox: n } = S(a, t, void 0, true), e = n.height + t.padding, s = n.width + e / 4 + t.padding, i = r.insert("rect", ":first-child").attr("style", t.style).attr("rx", e / 2).attr("ry", e / 2).attr("x", -s / 2).attr("y", -e / 2).attr("width", s).attr("height", e);
  return w(t, i), t.intersect = function(l) {
    return u.rect(t, l);
  }, r;
};
var Yt = (a, t) => {
  const { shapeSvg: r, bbox: n, halfPadding: e } = S(a, t, void 0, true), s = r.insert("circle", ":first-child");
  return s.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + e).attr("width", n.width + t.padding).attr("height", n.height + t.padding), et.info("Circle main"), w(t, s), t.intersect = function(i) {
    return et.info("Circle intersect", t, n.width / 2 + e, i), u.circle(t, n.width / 2 + e, i);
  }, r;
};
var Ut = (a, t) => {
  const { shapeSvg: r, bbox: n, halfPadding: e } = S(a, t, void 0, true), s = 5, i = r.insert("g", ":first-child"), l = i.insert("circle"), c = i.insert("circle");
  return l.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + e + s).attr("width", n.width + t.padding + s * 2).attr("height", n.height + t.padding + s * 2), c.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + e).attr("width", n.width + t.padding).attr("height", n.height + t.padding), et.info("DoubleCircle main"), w(t, l), t.intersect = function(o) {
    return et.info("DoubleCircle intersect", t, n.width / 2 + e + s, o), u.circle(t, n.width / 2 + e + s, o);
  }, r;
};
var At = (a, t) => {
  const { shapeSvg: r, bbox: n } = S(a, t, void 0, true), e = n.width + t.padding, s = n.height + t.padding, i = [
...
var Dt = (a, t) => {
  ...
  let f = 0;
  const p = t.classData.annotations && t.classData.annotations[0], g = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "", y = x.node().appendChild(R(g, t.labelStyle, true, true));
  let m = y.getBBox();
  if (_l(th().flowchart.htmlLabels)) {
    const E = y.children[0], B = nh(y);
    m = E.getBoundingClientRect(), B.attr("width", m.width), B.attr("height", m.height);
  }
  t.classData.annotations[0] && (d += m.height + n, h += m.width);
  let T2 = t.classData.label;
  t.classData.type !== void 0 && t.classData.type !== "" && (th().flowchart.htmlLabels ? T2 += "&lt;" + t.classData.type + "&gt;" : T2 += "<" + t.classData.type + ">");
  const $ = x.node().appendChild(R(T2, t.labelStyle, true, true));
  nh($).attr("class", "classTitle");
  let M = $.getBBox();
  if (_l(th().flowchart.htmlLabels)) {
    const E = $.children[0], B = nh($);
    M = E.getBoundingClientRect(), B.attr("width", M.width), B.attr("height", M.height);
  }
  ...
  t.classData.members.forEach((E) => {
    const B = T(E);
    let H = B.displayText;
    th().flowchart.htmlLabels && (H = H.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
...
var Gt = (a, t, r) => {
  ...
  if (t.link) {
    let s;
    th().securityLevel === "sandbox" ? s = "_top" : t.linkTarget && (s = t.linkTarget || "_blank"), n = a.insert("svg:a").attr("xlink:href", t.link).attr("target", s), e = q[t.shape](n, t, r);
  } else
...
function A(a, t) {
  th().flowchart.htmlLabels && a && (a.style.width = t.length * 9 + "px", a.style.height = "12px");
}
var sr = (a, t) => {
  et.info("Moving label abc78 ", a.id, a.label, O[a.id]);
  let r = t.updatedPath ? t.updatedPath : t.originalPath;
  if (a.label) {
    const n = O[a.id];
    let e = a.x, s = a.y;
    if (r) {
      const i = fs.calcLabelPosition(r);
      et.info(
  ...
  if (a.startLabelLeft) {
    ...
    let e = a.x, s = a.y;
    if (r) {
      const i = fs.calcTerminalLabelPosition(a.arrowTypeStart ? 10 : 0, "start_left", r);
      e = i.x, s = i.y;
    }
    n.attr("transform", "translate(" + e + ", " + s + ")");
  }
  if (a.startLabelRight) {
    ...
    let e = a.x, s = a.y;
    if (r) {
      const i = fs.calcTerminalLabelPosition(
  ...
  if (a.endLabelLeft) {
    ...
    let e = a.x, s = a.y;
    if (r) {
      const i = fs.calcTerminalLabelPosition(a.arrowTypeEnd ? 10 : 0, "end_left", r);
      e = i.x, s = i.y;
    }
    n.attr("transform", "translate(" + e + ", " + s + ")");
  }
  if (a.endLabelRight) {
    ...
    let e = a.x, s = a.y;
    if (r) {
      const i = fs.calcTerminalLabelPosition(a.arrowTypeEnd ? 10 : 0, "end_right", r);
      e = i.x, s = i.y;
    }
    n.attr("transform", "translate(" + e + ", " + s + ")");
  }
...
var zt = (a, t, r) => {
  ...
  if (Math.abs(e - t.y) * i > Math.abs(n - t.x) * c) {
    ...
    return l === 0 && (x.x = t.x, x.y = t.y), h === 0 && (x.x = t.x), o === 0 && (x.y = t.y), et.warn(`abc89 topp/bott calc, Q ${o}, q ${d}, R ${h}, r ${l}`, x), x;
  } else {
    r.x < t.x ? l = t.x - i - n : l = n - i - t.x;
    let d = o * l / h, x = r.x < t.x ? r.x + h - l : r.x - h + l, f = r.y < t.y ? r.y + d : r.y - d;
    return et.warn(`sides calc abc89, Q ${o}, q ${d}, R ${h}, r ${l}`, { _x: x, _y: f }), l === 0 && (x = t.x, f = t.y), h === 0 && (x = t.x), o === 0 && (f = t.y), { x, y: f };
  }
};
var F = (a, t) => {
  et.warn("abc88 cutPathAtIntersect", a, t);
  let r = [], n = a[0], e = false;
  return a.forEach((s) => {
    if (et.info("abc88 checking point", s, t), !Zt(t, s) && !e) {
      const i = zt(t, n, s);
      et.warn("abc88 inside", s, n, i), et.warn("abc88 intersection", i);
      let l = false;
      r.forEach((c) => {
        l = l || c.x === i.x && c.y === i.y;
      }), r.some((c) => c.x === i.x && c.y === i.y) ? et.warn("abc88 no intersect", i, r) : r.push(i), e = true;
    } else
      et.warn("abc88 outside", s, n), n = s, e || r.push(s);
  }), et.warn("abc88 returning points", r), r;
};
var ir = function(a, t, r, n, e, s) {
  let i = r.points, l = false;
  const c = s.node(t.v);
  var o = s.node(t.w);
  et.info("abc88 InsertEdge: ", r), o.intersect && c.intersect && (i = i.slice(1, r.points.length - 1), i.unshift(c.intersect(i[0])), et.info(
    "Last point",
    i[i.length - 1],
    o,
    o.intersect(i[i.length - 1])
  ), i.push(o.intersect(i[i.length - 1]))), r.toCluster && (et.info("to cluster abc88", n[r.toCluster]), i = F(r.points, n[r.toCluster].node), l = true), r.fromCluster && (et.info("from cluster abc88", n[r.fromCluster]), i = F(i.reverse(), n[r.fromCluster].node).reverse(), l = true);
  const h = i.filter((m) => !Number.isNaN(m.y));
  let d;
  e === "graph" || e === "flowchart" ? d = r.curve || Ue : d = Ue;
  const x = z().x(function(m) {
    return m.x;
  }).y(function(m) {
    return m.y;
  }).curve(d);
  ...
  let g = "";
  switch ((th().flowchart.arrowMarkerAbsolute || th().state.arrowMarkerAbsolute) && (g = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, g = g.replace(/\(/g, "\\("), g = g.replace(/\)/g, "\\)")), et.info("arrowTypeStart", r.arrowTypeStart), et.info("arrowTypeEnd", r.arrowTypeEnd), r.arrowTypeStart) {
    case "arrow_cross":
...
//# sourceMappingURL=chunk-T5SH2WB4.js.map
