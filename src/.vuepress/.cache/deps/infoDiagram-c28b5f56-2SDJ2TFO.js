...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.0.2/node_modules/mermaid/dist/infoDiagram-c28b5f56.js
var L = function() {
  var h = function(c, t, e, n) {
    ...
    performAction: function(t, e, n, s2, r, i, k) {
      switch (i.length - 1, r) {
        case 1:
          return s2;
        case 4:
    ...
    parse: function(t) {
      var e = this, n = [0], s2 = [], r = [null], i = [], k = this.table, $ = "", b = 0, T = 0, z = 2, R = 1, M = i.slice.call(arguments, 1), o = Object.create(this.lexer), p = { yy: {} };
      ...
      function U() {
        var u;
        return u = s2.pop() || o.lex() || R, typeof u != "number" && (u instanceof Array && (s2 = u, u = s2.pop()), u = e.symbols_[u] || u), u;
      }
    ...
    var c = {
      ...
      unput: function(t) {
        ...
        return this.yylloc = {
          ...
          last_column: n ? (n.length === s2.length ? this.yylloc.first_column : 0) + s2[s2.length - n.length].length - n[0].length : this.yylloc.first_column - e
...
` + e + "^";
      ...
      test_match: function(t, e) {
        ...
        }, this.options.ranges && (r.yylloc.range = this.yylloc.range.slice(0))), s2 = t[0].match(/(?:\r\n?|\n).*/g), s2 && (this.yylineno += s2.length), this.yylloc = {
          first_line: this.yylloc.last_line,
          last_line: this.yylineno + 1,
          first_column: this.yylloc.last_column,
          last_column: s2 ? s2[s2.length - 1].length - s2[s2.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + t[0].length
      ...
      next: function() {
        ...
        for (var r = this._currentRules(), i = 0; i < r.length; i++)
          if (n = this._input.match(this.rules[r[i]]), n && (!e || n[0].length > e[0].length)) {
            if (e = n, s2 = i, this.options.backtrack_lexer) {
        ...
        return e ? (t = this.test_match(e, r[s2]), t !== false ? t : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: function(e, n, s2, r) {
        switch (s2) {
          case 0:
            return 4;
          case 1:
...
` + h);
    const m = th().securityLevel;
    let _;
    m === "sandbox" && (_ = nh("#i" + f));
    const t = (m === "sandbox" ? nh(_.nodes()[0].contentDocument.body) : nh("body")).select("#" + f);
...
//# sourceMappingURL=infoDiagram-c28b5f56-2SDJ2TFO.js.map
